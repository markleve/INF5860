...
def config():
    ...
    # Relevant datasets will be put in the location data_root_dir/dataset. Change this to something
    # useful for you.
...
def plot_progress(train_progress, devel_progress, out_filename=None):
    ...
    if out_filename is not None:
        plt.savefig("../actual_figures/" + out_filename)
...
def main():
    ...
    plot_progress(train_progress, devel_progress, out_filename="trial1")
